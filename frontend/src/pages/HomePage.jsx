...
const HomePage = () => {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold mb-6 text-center bg-linear-to-r from-pink-400 to-rose-600 text-transparent bg-clip-text">
        Homepage
      </h2>
      ...
      >
        <motion.button
          ...
          className="w-full py-3 px-4 bg-linear-to-r from-pink-500 to-rose-600 text-white 
				font-bold rounded-lg shadow-lg hover:from-pink-600 hover:to-rose-700
